...
type LoginReq struct {
	...
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // 密码（客户端已做基础哈希）
	Platform string `protobuf:"bytes,3,opt,name=platform,proto3" json:"platform,omitempty"` // 平台标识：ios / android / pc / web
	Version  string `protobuf:"bytes,4,opt,name=version,proto3" json:"version,omitempty"`   // 客户端版本号
}
...
type LoginRes struct {
	...
	Token    string         `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` // JWT 或自定义 Session Token
	PlayerId uint64         `protobuf:"varint,3,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"`
	ExpireAt uint64         `protobuf:"varint,4,opt,name=expire_at,json=expireAt,proto3" json:"expire_at,omitempty"` // Token 过期时间戳
}
...
func (x *LoginRes) GetResult() *common.Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *LoginRes) GetPlayerId() uint64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
func (x *LoginRes) GetExpireAt() uint64 {
	if x != nil {
		return x.ExpireAt
	}
	return 0
...
func (x *RegisterRes) GetResult() *common.Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *RegisterRes) GetPlayerId() uint64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
func (x *VerifyTokenRes) GetResult() *common.Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *VerifyTokenRes) GetPlayerId() uint64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
func (x *VerifyTokenRes) GetExpireAt() uint64 {
	if x != nil {
		return x.ExpireAt
	}
	return 0
...
var file_login_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x69, 0x6e, 0x1a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x22, 0x76, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x18,
	...
	0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x82, 0x01, 0x0a, 0x08, 0x4c,
	0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x12, 0x26, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x72, 0x0a, 0x0e,
	0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x12, 0x26,
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x5f, 0x61, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x41, 0x74,
	0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67,
	0x6d, 0x61, 0x6b, 0x65, 0x72, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x62, 0x06,
...
var file_login_proto_goTypes = []interface{}{
	...
	(*RegisterReq)(nil),    // 2: login.RegisterReq
	(*RegisterRes)(nil),    // 3: login.RegisterRes
	(*VerifyTokenReq)(nil), // 4: login.VerifyTokenReq
	(*VerifyTokenRes)(nil), // 5: login.VerifyTokenRes
	(*common.Result)(nil),  // 6: common.Result
}
var file_login_proto_depIdxs = []int32{
	6, // 0: login.LoginRes.result:type_name -> common.Result
	6, // 1: login.RegisterRes.result:type_name -> common.Result
	6, // 2: login.VerifyTokenRes.result:type_name -> common.Result
