...
type Result struct {
	...
	Code uint32 `protobuf:"varint,2,opt,name=code,proto3" json:"code,omitempty"` // 0 表示成功，非零见 spec/errors.toml
...
func (x *PageReq) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *PageRes) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *PageRes) GetTotalPage() uint32 {
	if x != nil {
		return x.TotalPage
	}
	return 0
...
var file_common_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22, 0x3e, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x33, 0x0a, 0x07, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x68, 0x0a, 0x07, 0x50,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x01,
	...
	0x6c, 0x50, 0x61, 0x67, 0x65, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x2d,
	0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6d, 0x61,
	0x6b, 0x65, 0x72, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f,
